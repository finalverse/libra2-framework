...
module libra2_token_objects::libra2_token {
    ...
    public fun create_collection_object(
        ...
        let libra2_collection = AptosCollection {
            mutator_ref,
            royalty_mutator_ref,
            mutable_description,
            mutable_uri,
    ...
    public fun mint_token_object(
        ...
        if (freezable_by_creator) {
            ...
            let libra2_token = borrow_global_mut<AptosToken>(libra2_token_addr);
    ...
    public entry fun burn<T: key>(creator: &signer, token: Object<T>) acquires AptosToken {
        ...
        move libra2_token;
        let libra2_token = move_from<AptosToken>(object::object_address(&token));
        let AptosToken {
            burn_ref,
            transfer_ref: _,
            mutator_ref: _,
