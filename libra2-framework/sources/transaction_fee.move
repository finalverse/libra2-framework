...
module libra2_framework::transaction_fee {
    ...
    public(friend) fun store_libra2_coin_burn_cap(libra2_framework: &signer, burn_cap: BurnCapability<AptosCoin>) {
    ...
    public entry fun convert_to_libra2_fa_burn_ref(libra2_framework: &signer) acquires AptosCoinCapabilities {
    ...
    /// Only called during genesis.
    public(friend) fun store_libra2_coin_mint_cap(libra2_framework: &signer, mint_cap: MintCapability<AptosCoin>) {
        system_addresses::assert_libra2_framework(libra2_framework);
