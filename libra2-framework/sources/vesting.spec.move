spec libra2_framework::vesting {
    ...
    /// period.
    /// Enforcement: Audited the check for the end of vesting cliff: [https://github.com/finalverse/libra2/blob/main/libra2-move/framework/libra2-framework/sources/vesting.move#L566](vest) module.
    ///
    /// No.: 5
